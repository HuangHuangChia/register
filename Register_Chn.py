...
url='https://register.typc.mohw.gov.tw/OINetReg/OINetReg.Reg/Reg_NetReg.aspx'

path=currentpath+"Register_Chn_Html_old.txt"
#print(path)
path1=currentpath+"Register_Chn_Html_new.txt"

#path_counter=currentpath+"Register_Chn_counter.txt"
path_error=currentpath+"Register_Chn_error.txt"
